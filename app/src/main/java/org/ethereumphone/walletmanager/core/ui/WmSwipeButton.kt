...
fun WmSwipeButton(
    ...
    BoxWithConstraints(
            ...
            modifier = modifier
                ...
                .then(
                    if (swipeComplete) {
                        Modifier.size(WmSwipeButtonDefaults.iconContainer)
                    } else {
                        Modifier.fillMaxWidth()
                    }
                )
    ) {
        val iconSize = WmSwipeButtonDefaults.iconContainer
        ...
        AnimatedVisibility(
            ...
            Icon(
                completeIcon,
                contentDescription = "",
                modifier = Modifier.padding(WmButtonDefaults.iconPadding),
                tint = colors.content
            )
        }
    }
